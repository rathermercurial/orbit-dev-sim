...
We are also shipping the new Stellar content distribution network integration. Documentation and design assets are now cached at edge locations, which means international teams see dramatically faster load times. David and Elena led this initiative, and the early metrics from our beta cohort look promising.
